...
st.image('https://t1.daumcdn.net/brunch/service/user/zIH/image/nunmPyEY9gOSZRdvzk7owDtqXcY.jpg')

# video_file = open("img/SampleVideo_1280x720_1mb.mp4","rb")
# video_bytes = video_file.read()
# st.video(video_bytes)

st.video("https://www.youtube.com/watch?v=HsREtl0inIM")
